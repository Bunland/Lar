...
void queryStringCustomFunction(JSContextRef context, JSObjectRef larGlobalObject, const char *functionName, JSObjectCallAsFunctionCallback functionCallback) {
    // Create a JavaScript string from the function name in UTF-8 format.
    JSStringRef functionString = JSStringCreateWithUTF8CString(functionName);
...
void larApis(JSContextRef context, JSObjectRef globalObject) {
    ...
    JSStringRef queryStringPropertyName = JSStringCreateWithUTF8CString("querystring");
    JSObjectRef queryStringObject = JSObjectMake(context, NULL, NULL);
    JSObjectSetProperty(context, larGlobalObject, queryStringPropertyName, queryStringObject, kJSClassAttributeNone, NULL);
    ...
    queryStringCustomFunction(context, queryStringObject, "decode", Decode);
    queryStringCustomFunction(context, queryStringObject, "encode", Encode);
    queryStringCustomFunction(context, queryStringObject, "escape", Escape);
    queryStringCustomFunction(context, queryStringObject, "unescape", Unescape);
    ...
    JSStringRelease(lar);
    JSStringRelease(queryStringPropertyName);
